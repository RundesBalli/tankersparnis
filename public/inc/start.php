...
$content.= "<div class='row'>".PHP_EOL.
"<div class='col-s-12 col-l-12'>Wenn du ein Auto mit Autogas, Erdgas oder Wasserstoff fährst, dann kannst du auf tankersparnis.net deine Verbräuche eintragen um kostenlos zu erfahren, wie viel Geld du gegenüber herkömmlichem, fossilem Kraftstoff eingespart hast.</div>".PHP_EOL.
"<div class='col-s-12 col-l-12'>Außerdem behältst du so deine monatlichen Verbräuche und Kosten im Auge.</div>".PHP_EOL.
"</div>".PHP_EOL;
...
$content.= "<div class='row'>".PHP_EOL.
"<div class='col-s-12 col-l-12'>Warum nicht? Wenn du dich für Statistiken interessierst und gerne den Überblick über deinen Kraftstoffverbrauch behalten möchtest, ist diese Seite genau das Richtige für dich!</div>".PHP_EOL.
"</div>".PHP_EOL;
